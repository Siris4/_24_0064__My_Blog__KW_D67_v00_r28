...
db_path = 'C:/Users/Siris/Desktop/GitHub Projects 100 Days NewB/_24_0071__Day67_RESTful_Blog_with_Editing__240717/NewProject/r20-r29/r28_env_NWY/instance/posts.db'
...
def add_new_post():
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        print(f"New Post Slug: {new_post.slug}")  # Debugging print statement
...
def edit_post(post_id):
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        print(f"Edited Post Slug: {post.slug}")  # Debugging print statement
